...
<form name="e" method="post" action="">
    Value to encrypt: <input type="text" name="val" value="<?=isset($_POST["val"]) ? $_POST["val"] : "My string - Could also be an JS array/object"?>" class="val" size="45"/><br/>
    Passphrase: <input type="text" name="pass" class="pass" value="<?=isset($_POST["pass"]) ? $_POST["pass"] : "my secret passphrase"?>" size="45"/><br/>
    ...
    if(isset($_POST["encrypt"])){
        ...
        <hr/>
        <br/><br/>
        Encrypted value generated by PHP: <input type="text" value="<?=htmlentities(cryptoJsAesEncrypt($_POST["pass"], $_POST["val"]))?>" size="90" disabled="disabled" class="encrypted"/><br/>
